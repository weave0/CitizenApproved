      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-28 pb-12">
        ...
        <div className="mb-8 p-4 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
          ...
          <p className="text-gray-300 text-sm">
            Most applicants only need <strong>Form N-400</strong>{" "}
            (naturalization) or <strong>Form N-600</strong> (proof of existing
            citizenship). All forms are available for free download from{" "}
            <a
        ...
        {FORM_CATEGORIES.map((category) => {
          const categoryForms = ALL_FORMS.filter((f) =>
            category.forms.includes(f.formNumber),
          );
          return (
                          ...
                          {form.filingFee !== undefined && (
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-gray-300">
                                {form.filingFee === 0
                                  ? "No fee"
                                  : `$${form.filingFee.toLocaleString()}`}
                                {form.biometricsFee
                                  ? ` + $${form.biometricsFee} biometrics`
                                  : ""}
                              </span>
                            </div>
                          )}
        ...
        <div className="mb-8 glass-panel p-6">
          ...
          <ul className="space-y-3 text-sm text-gray-300">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Always use the latest version</strong> of each form.
                USCIS rejects outdated editions. Check the edition date in the
                bottom-left corner.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">•</span>
              <span>
                <strong>File online when available.</strong> N-400 can be filed
                online at{" "}
                <a
                ...
                , which is faster and allows tracking.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">•</span>
              <span>
                <strong>Fee waivers (I-912)</strong> are available for
                applicants receiving means-tested benefits or with income below
            ...
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">•</span>
              <span>
                <strong>Military applicants</strong> pay no filing fee for N-400
                when filing under INA § 328 or § 329.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-400 mt-0.5">•</span>
              <span>
                <strong>Keep copies</strong> of everything you submit. Send by
                certified mail or use online filing for delivery confirmation.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">
                Calculate total fees and waiver eligibility
              </div>
            </div>
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-500">
                Track documents needed for your pathway
              </div>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-500 group-hover:text-cyan-400" />
          </Link>
        ...
        <div className="mt-8 p-4 bg-gray-900/50 border border-gray-800 rounded-lg">
          <p className="text-xs text-gray-500 text-center">
            <strong>Disclaimer:</strong> Forms and fees are subject to change.
            Always verify current requirements on{" "}
            <a
              href="https://www.uscis.gov/forms"
              target="_blank"
              rel="noopener noreferrer"
