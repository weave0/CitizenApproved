...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50" aria-label="Primary navigation">
      ...
      {isOpen && (
        <div id="mobile-navigation" className="lg:hidden absolute top-full left-0 right-0 bg-[#050508]/98 backdrop-blur-xl border-b border-white/[0.08] max-h-[calc(100vh-4rem)] overflow-y-auto">
          <div className="px-4 py-4 space-y-1">
            ...
            <Link href="/about" onClick={() => setIsOpen(false)} className="block px-4 py-3 text-white/80 hover:text-white hover:bg-white/[0.06] rounded-lg transition-colors">About</Link>
